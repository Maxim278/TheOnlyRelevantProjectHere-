...
export let addSymbolActionCreator = (currentTextareaValue) => {
    return {type: SYMBOL_ADDING, symbol: currentTextareaValue};
}
export let addPostActionCreator = () => {
    return {type: PUSH_POST};
}

let postPageReducer = (state = initialState, action) => {
    switch (action.type) {
        case PUSH_POST: {
            let stateCopy = {...state};
            ...
            let newPost = {
                ...
                postText: state.symbolAddingString,
                postLikes: 'Likes: 0',
            };
        ...
        case SYMBOL_ADDING: {
            let stateCopy = {...state};
            stateCopy.symbolAddingString = action.symbol;
            return stateCopy;
        }
        default:
            return state;
